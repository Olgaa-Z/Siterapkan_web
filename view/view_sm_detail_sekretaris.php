...
if($sm->rowCount() >= 1){
	...
	<div class="widget-box">
		...
		<div class="message-body">
			...
			<p>
				Retensi surat / Jatuh tempo : <br/><b><?php echo ($data_sm->tgl_retensi == '0000-00-00' ? '-' : tgl_indo($data_sm->tgl_retensi));?></b>
			</p>
			<p>
			...
			<ul class="pager"><?php
				if($data_sm->file != ''){?>
				<li class="previous">
					<a href="./berkas/<?php echo $data_sm->file;?>"  class="btn">Lihat Surat<i class="ace-icon fa fa-file-pdf-o align-top bigger-125 icon-on-right"></i></a>
				</li><?php
				}
				if($HakAkses->sm == "W"){?>
				<li class="next">
					<a href="./index.php?op=add_sm&smid=<?php echo $data_sm->id_sm;?>" class="btn ">Edit Surat<i class="ace-icon fa fa-pencil align-top bigger-125 icon-on-right"></i></a>
				</li><?php
				}?>
			</ul>
		</div>
