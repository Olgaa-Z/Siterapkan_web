				...
				<div class="col-md-12">
					<div class="box box-primary">
						<div class="box-header">
							<h3 class="box-title">Konfigurasi Email <?php
							$params = array(':id' => $_GET['GetId']);
							$KopEmail = $this->model->selectprepare("email_setting", $field=null, $params, "id=:id");
							if($KopEmail->rowCount() >= 1){
						...
						<div class="widget-body">
							...
							<form class="form-horizontal" role="form" name="formku" method="GET">	
								...
								<div class="form-group">
									...
									<span style="padding-right: auto;"  data-placement="left" class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Pilih kop email yang tersedia" >
