...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Login Page - E-Office</title>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">E-Office</span>
									<span class="brown" id="id-text2">Maluku Tengah</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; <?php echo date('Y'); ?> E-Office </h4>
							</div>
