			...
			<div class="col-md-12">
				<div class="box box-primary">
					<div class="box-header">
						<h3 class="box-title">Laporan Progress Surat Masuk</h3>
					</div>
					<div class="box-body">
						...
						<div class="widget-body">
							<div class="widget-main">
								...
								<label for="id-date-range-picker-1" style="margin-bottom: 10px; margin-top: 10px;">Filter Tanggal Surat</label>
								<div class="row">
								...
								<label for="id-date-range-picker-1" style="margin-bottom: 10px; margin-top: 10px;">Filter No Agenda / Nomor surat</label>
								<div class="row">
									<div class="col-xs-8 col-sm-11">
										<div class="input-group">
