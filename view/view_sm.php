						...
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tbody><?php
											...
											foreach ($dump_sm as $key => $object) {
												...
												$tgl_retensi = date_format(date_create($object->tgl_retensi), "d-m-Y");
									...
									<tr>
										...
										<td><?php echo $object->no_sm; ?>
										<td><?php echo $object->pengirim; ?>
										<td><?php echo $object->perihal; ?>
											<?php echo $label_expired; ?>
										</td>
													...
													<div class="col-xs-12 col-sm-12">
														...
														<div class="profile-user-info profile-user-info-striped">
															...
															<div class="profile-info-row">
																...
																<div class="profile-info-value"><span><?php echo ($object->tgl_surat == '0000-00-00' ? '-' : tgl_indo($object->tgl_surat)); ?></span></div>
															</div>
															<div class="profile-info-row">
																<div class="profile-info-name"> Tanggal Terima </div>
																<div class="profile-info-value"><span><?php echo ($object->tgl_terima == '0000-00-00' ? '-' : tgl_indo($object->tgl_terima)); ?></span></div>
															</div>
															<div class="profile-info-row">
																<div class="profile-info-name"> Jatuh Tempo </div>
																<div class="profile-info-value"><span><?php echo ($object->tgl_retensi == '0000-00-00' ? '-' : tgl_indo($object->tgl_retensi)); ?></span></div>
															</div>
															<div class="profile-info-row">
										...
										<div class="table-detail">
											<div class="row">
												<div class="modal-dialog modal-dialog-centered" role="document">
													<div class="modal-content">
														<div class="modal-header">
															<h3 class="modal-title" id="exampleModalLongTitle">Detail Surat</h3>
																		...
																		<div class="profile-user-info profile-user-info-striped">
																			<ul class="list-group list-group-unbordered">
																				<li class="list-group-item">
																					<b> No Agenda </b> <a href="./index.php?op=sm&smid=<?php echo $object->id_sm; ?>" class="pull-right"><span><?php echo $object->custom_noagenda; ?></a></span></a>
																				</li>
																				<li class="list-group-item">
																					<b>Nomor surat </b> <b class="pull-right"><span><?php echo $object->no_sm; ?></span></b>
																				</li>
																				<li class="list-group-item">
																					<b>Pengirim</b> <b class="pull-right"><span><?php echo $object->pengirim; ?></span></b>
																				</li>
																				<li class="list-group-item">
																					<b>Perihal </b> <b class="pull-right"><span><?php echo $object->perihal; ?></span></b>
																				</li>
																				<li class="list-group-item">
																					<b> Tanggal Surat</b> <b class="pull-right"><span><?php echo ($object->tgl_surat == '0000-00-00' ? '-' : tgl_indo($object->tgl_surat)); ?></span></b>
																				</li>
																				<li class="list-group-item">
																					<b> Tanggal Terima</b> <b class="pull-right"><span><?php echo ($object->tgl_terima == '0000-00-00' ? '-' : tgl_indo($object->tgl_terima)); ?></span></b>
																				</li>
																				<li class="list-group-item">
																					<b>Jatuh Tempo </b> <b class="pull-right"><span><?php echo ($object->tgl_retensi == '0000-00-00' ? '-' : tgl_indo($object->tgl_retensi)); ?></span></b>
																				</li>
																				<li class="list-group-item">
