		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header">
					<h3 class="box-title">Report Arsip Digital</h3>
				</div>
				<div class="box-body">
					...
					<div class="widget-body">
						<div class="widget-main">
							...
							<form class="form-horizontal" role="form" method="POST" name="formku" action="<?php echo $_SESSION['url'];?>">
								...
								<div class="row">
									<label for="id-date-range-picker-1" style="margin-bottom: 10px;">Filter Nomor Arsip</label>
									<div class="col-xs-8 col-sm-11">
										<div class="form-group">
											<input class="form-control" placeholder="Nomor arsip" type="text" name="noarsip" />
										</div>
									</div>
								...
								<div class="row">
									<label for="id-date-range-picker-1" style="margin-bottom: 10px;">Filter berdasarkan Range Tanggal</label>
									<div class="col-xs-8 col-sm-11">
										<div class="input-group">
											<span class="input-group-addon">
												<i class="fa fa-calendar bigger-110"></i>
											</span>
											<input class="form-control pull-right" type="text" name="rangetgl" id="reservation" />
										</div>
									</div>
									<div class="col-xs-1 col-sm-1">
										<label>
								...
								<div class="row" style="margin-bottom: 10px; margin-top: 10px;">
									<label for="id-date-range-picker-1" > Filter Klasifikasi         .</label>
									<div class="col-xs-8 col-sm-11">
										<div class="form-group">
											<select class="form-control select2" name="klasifikasi" data-placeholder="Pilih Klasifikasi..." style="width: 100%;">
