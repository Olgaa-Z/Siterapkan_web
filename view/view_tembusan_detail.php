	...
	<section class="invoice">
		...
		<div class="row">
			<div class="col-xs-12">
				<span class="blue bigger-125">
					Tembusan surat dari:  <?php echo $dataTembusan->pengirim;?> 
				</span>
				<h2 class="page-header">
					
					<img class="middle" alt="<?php echo $DataUser->nama;?>" src="assets/images/avatars/<?php echo $DataUser->picture;?>" width="32" />
					Ref: <?php echo $dataTembusan->custom_noagenda;?>
					<small class="pull-right"><i class="ace-icon fa fa-clock-o bigger-110 orange middle" style="margin-right: 10px;"></i><?php echo tgl_indo($tgl);?>, <?php echo substr($dataTembusan->tgl,-9,-3);?> WIB</small>
				</h2>
			</div> 
		...
		<div class="col-xs-10">
			...
			<div class="table-responsive">
				<table class="table">
					<tr>
						<th style="width:50%">Tgl terima/No agenda:</th>
						<td>:
							<td><b><?php echo tgl_indo($dataTembusan->tgl_terima);?> | <?php echo $dataTembusan->custom_noagenda;?></b>></td>

						</tr>
						<tr>
							<th>Dari</th>
							<td>:
								<td><b><?php echo $dataTembusan->pengirim;?></b></td>
							</tr>
							<tr>
								<th>Tgl/No surat </th>
								<td>:
									<td><b><?php echo tgl_indo($dataTembusan->tgl_surat);?> | <?php echo $dataTembusan->no_sm;?></b></td>
								</tr>
								<tr>
									<th>Perihal </th>
									<td>:
										<td><b><?php echo $dataTembusan->perihal;?></b></td>
									</tr>
									<tr>
										<th>Tanggal Tembusan </th>
										<td>:
											<td><b><?php echo tgl_indo($tgl);?></b></td>
										</tr>
									</table>
								</div>
							</div>
