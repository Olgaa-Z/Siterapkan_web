											...
											<div class="widget-main">
												<form class="form-horizontal" role="form" method="POST" name="formku" action="<?php echo $_SESSION['url'];?>">
													...
													<div class="form-group">
														...
														<span style="padding-right: auto;"  data-placement="left" class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Di isi dengan nama jabatan.">
						...
						//$akses_atur_infoapp = htmlspecialchars($purifier->purify(trim($_POST['akses_atur_infoapp'])), ENT_QUOTES);
									...
									//print_r($_POST);
																		...
																		<div class="widget-body">
																			...
																			<form class="form-horizontal" role="form" enctype="multipart/form-data" method="POST" name="formku" action="<?php echo $_SESSION['url'];?>">
																				...
																				<div class="form-group">
																					...
																					<span style="padding-right: auto;"  data-placement="left" class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Di isi dengan NIK/NIP Pengguna.p">
																						<i class="fa fa-question-circle"></i>
																					</span>
																				</div>
																				<div class="space-4"></div>
																				<div class="form-group">
																					...
																					<span style="padding-right: auto;"  data-placement="left" class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Di isi dengan Nama Lengkap Pengguna.">
																						<i class="fa fa-question-circle"></i>
																					</span>
																				</div>
																				<div class="space-4"></div>
																				<div class="form-group">
																					...
																					<span style="padding-right: auto;"  data-placement="left" class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Username untuk login.">
																						<i class="fa fa-question-circle"></i>
																					</span>
																				</div>
																				<div class="space-4"></div>
																				<div class="form-group">
																					...
																					<span style="padding-right: auto;"  data-placement="left" class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Password untuk login">
																						<i class="fa fa-question-circle"></i>
																					</span>
																				</div>
																				<div class="space-4"></div>
																				<div class="form-group">
																					...
																					<span style="padding-right: auto;"  data-placement="left" class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Email Pengguna">
																						<i class="fa fa-question-circle"></i>
																					</span>
																					</div><?php
											/*
											...
											<div class="form-group">
												...
												<span style="padding-right: auto;"  data-placement="left" class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Pilih Jabatan">
													<i class="fa fa-question-circle"></i>
												</span>
											</div>

											<div class="form-group">
												<label for="inputPassword3" class="col-sm-2 control-label">Dapat melakukan Disposisi ke</label>

												<div class="col-sm-9">
													<select multiple="" class="select2 form-control" name="disposisi[]" id="form-field-select-3" data-placeholder="Pilih user..."><?php
											...
											<span style="padding-right: auto;"  data-placement="left" class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Pilih Group Level Disposisi">
												<i class="fa fa-question-circle"></i>
											</span>
										</div>
																							...
																							if(!isset($_GET['userid'])){?>
																								<table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
																									<thead>
																										<tr>
																											<th width="50">No</th>
																											<th width="200">NIK/NIP</th>
																											<th>Nama Lengkap</th>
																											<th class="detail-col" width="100">Details</th>
																											<th width="100">Aksi</th></th>
																										</tr>
																									</thead>
																									<tbody><?php
																									$no=1+$posisi;
																																		...
																																		<div class="col-xs-12 col-sm-12">
																																			...
																																			<div class="profile-user-info profile-user-info-striped">
																																				<div class="profile-info-row">
																																					<div class="profile-info-name"> NIK/NIP </div>
																																					<div class="profile-info-value"><span><?php echo $data_user->nik;?></span></div>
																																				</div>
																																				<div class="profile-info-row">
																																					<div class="profile-info-name"> Nama Lengkap </div>
																																					<div class="profile-info-value"><span><?php echo $data_user->nama;?></span></div>
																																				</div>
																																				<div class="profile-info-row">
																																					<div class="profile-info-name"> Username </div>
																																					<div class="profile-info-value"><span><?php echo $data_user->uname;?></span></div>
																																				</div>
																																				<div class="profile-info-row">
																																					<div class="profile-info-name"> Jabatan </div>
																																					<div class="profile-info-value"><span><?php echo $JabUser;?></span></div>
																																				</div>
																																				<div class="profile-info-row">
																																					<div class="profile-info-name"> Level Disposisi </div>
												...
												<div class="modal-dialog modal-dialog-centered" role="document">
													<div class="modal-content">
														<div class="modal-header">
															<h3 class="modal-title" id="exampleModalLongTitle">Detail User</h3>
																		...
																		<div class="profile-user-info profile-user-info-striped">
																			<ul class="list-group list-group-unbordered">
																				<li class="list-group-item">
																					<b>NIK/NIP  </b> <b class="pull-right"><span><?php echo $data_user->nik;?></span></b>
																				</li>
																				<li class="list-group-item">
																					<b> Nama Lengkap</b> <b class="pull-right"><span><?php echo $data_user->nama;?></span></b>
																				</li>
																				<li class="list-group-item">
																					<b> Username</b> <b class="pull-right"><span><?php echo $data_user->uname;?></span></b>
																				</li>
																				<li class="list-group-item">
																					<b> Jabatan</b> <b class="pull-right"><span><?php echo $JabUser;?></span></b>
																				</li>
																				<li class="list-group-item">
																					<b> Level Disposisi</b> <b class="pull-right"><span><?php 
																					if(is_array($ruleDispo)){
																						foreach($ruleDispo as $field => $value){
																							$GetUserDis = $this->model->selectprepare("user", $field=null, $params=null, $where=null, "WHERE id_user='$value'")->fetch(PDO::FETCH_OBJ);
																							echo '- '.$GetUserDis->nama .'<br/>';
