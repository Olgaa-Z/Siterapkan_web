		...
		<div class="row">
			<div class="col-xs-12">
				<span class="blue bigger-125">
					Disposisi surat :  <?php echo $data_Disposisi->perihal;?>
				</span>
				<h2 class="page-header">
					
					<img class="middle" alt="<?php echo $DataUser->nama;?>" src="assets/images/avatars/<?php echo $DataUser->picture;?>" width="32" /> <?php echo $DataUser->nama;?>
					<small class="pull-right"><i class="ace-icon fa fa-clock-o bigger-110 orange middle" style="margin-right: 10px;"></i><?php echo tgl_indo($tgl_disposisi);?>, <?php echo substr($data_Disposisi->tgl,-9,-3);?> WIB</small>
				</h2>
			</div>
			...
			<div class="table-responsive">
				<table class="table">
					<tr>
						...
						<td>:
							<td><b><?php echo tgl_indo($data_Disposisi->tgl_terima);?> | <?php echo $data_Disposisi->custom_noagenda;?></b></td>

						</tr>
						<tr>
							<th>Dari</th>
							<td>:
								<td><b><?php echo $data_Disposisi->pengirim;?></b></td>
							</tr>
							<tr>
								<th>Tgl/No surat</th>
								<td>:
									<td><b><?php echo tgl_indo($data_Disposisi->tgl_surat);?> | <?php echo $data_Disposisi->no_sm;?></b></td>
								</tr>
								<tr>
									<th>Perihal </th>
									<td>:
										<td><b><?php echo $data_Disposisi->perihal;?> </b></td>
									</tr>
									<tr>
										<th>Keterangan </th>
										<td>:
											<td><b><?php echo $data_Disposisi->ket;?></b></td>
										</tr>
									</table>
								</div>
							</div>
							...
							<p>Detail Disposisi: <br/>
								<span >
									<a href="./index.php?op=disposisiprint&smid=<?php echo $data_Disposisi->id_sm;?>&iduser=<?php echo $_SESSION['id_user']; ?>&dispo=<?php echo $DataUser->id_user;?>" target="_blank" class="btn btn-primary"><b>Lihat</b></a>
								</span>
								<span >
									<a href="./index.php?op=disposisiprint&smid=<?php echo $data_Disposisi->id_sm;?>&iduser=<?php echo $_SESSION['id_user']; ?>&dispo=<?php echo $DataUser->id_user;?>&act=pdf" target="_blank" class="btn btn-danger"><b>Cetak</b> <i class="ace-icon fa fa-file-pdf-o align-top bigger-125 icon-on-right"></i></a>
								</span>
							</p>

						</section>
						<!-- end section of detail disposisi surat -->
					...
					if($CekLevelDispo->rule_disposisi != 'null'){
										...
										<div class="widget-main">
											<form class="form-horizontal" role="form" method="POST" name="formku" action="<?php echo $_SESSION['url'];?>">
												<div class="form-group">
													...
													<div class="col-sm-6">
														<select multiple="" class="select2 form-control" name="tujuan[]" id="form-field-select-3" data-placeholder="Pilih user..." required><?php
												...
												<span style="padding-right: auto;"  data-placement="left" class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Di isi sesuai dengan pilihan user yang tersedia">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<select multiple="" class="select2 form-control"  name="tembusan[]" id="form-field-select-4"  data-placeholder="Pilih user..."><?php
											...
											<span style="padding-right: auto;"  data-placement="left" class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Pilih tujuan tembusan surat (support multiple choise).">
												<i class="fa fa-question-circle"></i>
											</span>
										</div>
										<div class="form-group">
											...
											<span style="padding-right: auto;"  data-placement="left" class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Di isi berupa keterangan/catatan tambahan terhadap surat yang di disposisi.">
												<i class="fa fa-question-circle"></i>
											</span>
										</div>
						...
						if($data_Disposisi->file != ''){?>
							<li class="previous">
								<a href="./berkas/<?php echo $data_Disposisi->file;?>" target="_blank" class="btn">Lihat Surat<i class="ace-icon fa fa-file-pdf-o align-top bigger-125 icon-on-right"></i></a>
								</li><?php
							}
							if($cekDisposisiku->rowCount() >= 1){?>
								<li class="next btn btn-primary pull-right"><a href="./index.php?op=disposisi&smid=<?php echo $data_Disposisi->id_sm;?>&id_user=<?php echo $DataUser->id_user;?>&act=disposisi" class="btn">Telah di-Disposisi<i class="ace-icon fa fa-pencil align-top bigger-125 icon-on-right"></i></a>
									</li><?php
								}else{?>
									<li class="next btn btn-primary pull-right"><a href="./index.php?op=disposisi&smid=<?php echo $data_Disposisi->id_sm;?>&id_user=<?php echo $DataUser->id_user;?>&act=disposisi" class="btn">Disposisi<i class="ace-icon fa fa-share align-top bigger-125 icon-on-right"></i></a>
										</li><?php
									}?>
									</ul><?php
								}
