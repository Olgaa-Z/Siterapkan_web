			...
			<div class="col-md-12">
				<div class="box box-primary">
					<div class="box-header">
						<h3 class="box-title">Laporan Disposisi Surat</h3>
					</div>
					<div class="box-body">

						<div class="widget-body">
							<div class="widget-main">
								<label for="id-date-range-picker-1" style="margin-bottom: 10px; margin-top: 10px;">Filter Tanggal Disposisi</label>
								<div class="row">
									<div class="col-xs-8 col-sm-11">
										<div class="input-group">
											...
											<input class="form-control pull-right" name="rangetgl" type="text" name="rangetgl" id="reservation" />
										</div>
									</div>
								...
								<label for="id-date-range-picker-1" style="margin-bottom: 10px; margin-top: 10px;">Filter User Tujuan Disposisi </label>
								<div class="row" style="margin-left: 0px;">
									<div class="col-xs-8 col-sm-11">
										<div class="form-group">
											<select class="form-control select2" name="user" data-placeholder="Pilih User..." style="width: 100%;">
